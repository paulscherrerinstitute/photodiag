...
# ---- tools
waveform_plot_hover = HoverTool(tooltips=[
    ("energy, eV", '@en'),
    ("etof time, a.u.", '$x'),
    ("intensity, a.u.", '$y'),
])

waveform_plot.add_tools(PanTool(), BoxZoomTool(), WheelZoomTool(), ResetTool(), waveform_plot_hover)
...
# ---- vertical spans
photon_peak_ref_span = Span(location=0, dimension='height', line_dash='dashed', line_color='blue')
photon_peak_str_span = Span(location=0, dimension='height', line_dash='dashed', line_color='red')
